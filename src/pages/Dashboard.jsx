    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          .grind-main-content { margin-left: 0; }
        }
        ...
        @media (max-width: 900px) {
          .grind-stat-grid { grid-template-columns: repeat(2, 1fr); }
        }
        @media (max-width: 480px) {
          .grind-stat-grid { grid-template-columns: repeat(2, 1fr); gap: 8px; }
        }
        ...
        @media (max-width: 700px) {
          .grind-weekly-grid { grid-template-columns: 1fr; }
        }
        ...
        @media (max-width: 480px) {
          .grind-week-inner { grid-template-columns: 1fr; }
        }
        ...
        @media (max-width: 800px) {
          .grind-feedback-grid { grid-template-columns: 1fr; }
        }
        ...
        @media (max-width: 480px) {
          .grind-content-pad { padding: 16px; }
        }
      ...
      >
        ...
        <div className="grind-main-content">
          <Topbar
          ...
          <main className="grind-content-pad">
            {/* ── Stat Cards ── */}
            <div className="grind-stat-grid">
              <StatCard
                label="Run Distance"
            ...
            {/* ── WEEKLY SUMMARY ── */}
            {activePage === "weekly" && (
              <div className="grind-weekly-grid">
                {/* This Week */}
                <div className="grind-panel">
                  <div className="grind-panel-header">
                    <h3 className="grind-panel-title">This Week</h3>
                    <button
                      className="grind-export-btn"
                  ...
                  <div className="grind-week-inner">
                    {[
                ...
                <div className="grind-panel">
                  <div className="grind-panel-header">
                    <h3 className="grind-panel-title">This Month</h3>
                    <button
                      className="grind-export-btn"
            ...
            {/* ── FEEDBACK ── */}
            {activePage === "feedback" && (
              <div className="grind-feedback-grid">
                {/* Coach Feedback */}
                <div className="grind-panel">
                  <h3
                    className="grind-panel-title"
